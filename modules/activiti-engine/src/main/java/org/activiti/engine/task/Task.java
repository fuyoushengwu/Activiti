...
public interface Task extends TaskInfo {
  ...
  /**
   * delegates this task to the given user and sets the {@link #getDelegationState()
   * delegationState} to {@link DelegationState#PENDING}. If no owner is set on the task, the owner
   * is set to the current assignee of the task.
   */
