...
public class TimerExecuteNestedActivityJobHandler extends TimerEventHandler implements JobHandler {
  ...
  private static final Logger log =
      LoggerFactory.getLogger(TimerExecuteNestedActivityJobHandler.class);
  ...
  public void execute(
    ...
    ActivityImpl borderEventActivity =
        execution.getProcessDefinition().findActivity(nestedActivityId);
  ...
  protected void dispatchActivityTimeoutIfNeeded(
      JobEntity timerEntity, ExecutionEntity execution, CommandContext commandContext) {

    String nestedActivityId =
        TimerEventHandler.getActivityIdFromConfiguration(timerEntity.getJobHandlerConfiguration());
