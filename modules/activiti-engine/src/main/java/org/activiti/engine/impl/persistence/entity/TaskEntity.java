...
public class TaskEntity extends VariableScopeImpl
    implements Task, DelegateTask, Serializable, PersistentObject, HasRevision, BulkDeleteable {
  ...
  /**
   * Creates a new task. Embedded state and create time will be initialized. But this task still
   * will have to be persisted. See {@link #insert(ExecutionEntity))}.
   */
      ...
      Context.getProcessEngineConfiguration()
          ...
          .dispatchEvent(
              ActivitiEventBuilder.createEntityWithVariablesEvent(
                  ActivitiEventType.TASK_COMPLETED, this, variablesMap, localScope));
    }
  ...
  public void setExecution(DelegateExecution execution) {
    if (execution != null) {
      ...
      Context.getCommandContext()
          .getHistoryManager()
          .recordTaskExecutionIdChange(this.id, executionId);
  ...
  public void setAssignee(
      String assignee, boolean dispatchAssignmentEvent, boolean dispatchUpdateEvent) {
    CommandContext commandContext = Context.getCommandContext();
