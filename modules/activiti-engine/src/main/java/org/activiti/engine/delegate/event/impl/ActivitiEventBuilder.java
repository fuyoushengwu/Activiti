...
public class ActivitiEventBuilder {
   ...
   *     event is a global event, independant of any running execution.
   */
  public static ActivitiEvent createGlobalEvent(ActivitiEventType type) {
    return new ActivitiEventImpl(type);
  }
  ...
  public static ActivitiCancelledEvent createCancelledEvent(
  ...
  public static ActivitiSignalEvent createSignalEvent(
      ActivitiEventType type,
      String activityId,
      String signalName,
      Object signalData,
  ...
  public static ActivitiMessageEvent createMessageEvent(
      ActivitiEventType type,
      String activityId,
      String messageName,
      Object payload,
      ...
      if (event instanceof ActivitiEntityEvent) {
        ...
        if (persistendObject instanceof Job) {
          ...
          event.setProcessDefinitionId(
              ((DelegateExecution) persistendObject).getProcessDefinitionId());
