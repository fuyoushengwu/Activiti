...
public class Parser {
  ...
  public abstract static class ExtensionHandler {
    ...
    /**
     * Called by the parser if it handles a extended token associated with this handler at the
  ...
  protected AstBracket createAstBracket(
      AstNode base, AstNode property, boolean lvalue, boolean strict) {
  ...
  /**
   * consume current token (get next token); throw exception if the current token doesn't match the
   * expected symbol.
   */
  ...
  /**
   * value := (nonliteral | literal) (&lt;DOT&gt; &lt;IDENTIFIER&gt; | &lt;LBRACK&gt; expr
   * &lt;RBRACK&gt;)*
   */
  ...
  /**
   * nonliteral := &lt;IDENTIFIER&gt; | function | &lt;LPAREN&gt; expr &lt;RPAREN&gt; function :=
   * (&lt;IDENTIFIER&gt; &lt;COLON&gt;)? &lt;IDENTIFIER&gt; &lt;LPAREN&gt; list? &lt;RPAREN&gt;
   */
  protected AstNode nonliteral() throws ScanException, ParseException {
    ...
    switch (token.getSymbol()) {
      case IDENTIFIER:
        ...
        if (token.getSymbol() == COLON
            && lookahead(0).getSymbol() == IDENTIFIER
            && lookahead(1).getSymbol() == LPAREN) { // ns:f(...)
          consumeToken();
          name += ":" + token.getImage();
          consumeToken();
        }
  ...
  /**
   * literal := &lt;TRUE&gt; | &lt;FALSE&gt; | &lt;STRING&gt; | &lt;INTEGER&gt; | &lt;FLOAT&gt; |
   * &lt;NULL&gt;
   */
