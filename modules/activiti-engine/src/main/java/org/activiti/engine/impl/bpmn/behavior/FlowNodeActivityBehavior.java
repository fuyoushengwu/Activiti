...
public abstract class FlowNodeActivityBehavior implements SignallableActivityBehavior {
  ...
  private static final Pattern scopeRegexPattern =
  ...
  protected boolean isSignalEventAlreadyFired(
      ActivityExecution execution, EventSubscriptionEntity subscription) {
  ...
  protected String getEventSubscriptionScope(
      ActivityExecution execution, EventSubscriptionEntity subscription) {
  ...
  protected String getSignalExecutionScope(
      ActivityExecution execution, String signalName, String signalScope) {
    return String.format(
        FIRED_EVENT_SIGNAL_FORMAT,
        signalName,
