...
public class MapELResolver extends ELResolver {
   ...
   * property argument. Otherwise, returns null. Assuming the base is a Map, this method will always
   ...
   * java.beans.FeatureDescriptor. Each info object contains information about a key in the Map, and
   ...
   *     objects, each representing a key in this map, or null if the base object is not a map.
   */
  @Override
