        ...
        new Command<Void>() {
          ...
          public Void execute(CommandContext commandContext) {
            CommandConfig commandConfig =
                commandExecutor.getDefaultConfig().transactionRequiresNew();
            ...
            // Dispatch an event, indicating job execution failed in a try-catch block, to prevent
            // the original
            ...
            if (commandContext.getEventDispatcher().isEnabled()) {
              try {
                ...
                log.warn(
                    "Exception occured while dispatching job failure event, ignoring.", ignore);
              }
            }
