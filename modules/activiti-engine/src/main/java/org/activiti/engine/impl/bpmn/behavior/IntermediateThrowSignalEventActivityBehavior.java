...
public class IntermediateThrowSignalEventActivityBehavior extends AbstractBpmnActivityBehavior {
  ...
  public IntermediateThrowSignalEventActivityBehavior(
      ThrowEvent throwEvent, Signal signal, EventSubscriptionDeclaration signalDefinition) {
      ...
      subscriptionEntities =
          commandContext
              ...
              .findSignalEventSubscriptionsByProcessInstanceAndEventName(
                  execution.getProcessInstanceId(), signalDefinition.getEventName());
    } else {
      ...
      subscriptionEntities =
          commandContext
              ...
              .findSignalEventSubscriptionsByEventName(
                  signalDefinition.getEventName(), execution.getTenantId());
    }
