...
/**
 * Parsed expression, usually created by a {@link org.activiti.engine.impl.juel.TreeBuilder}. The
 * {@link #bind(FunctionMapper, VariableMapper)} method is used to create {@link
 * org.activiti.engine.impl.juel.Bindings}, which are needed at evaluation time to lookup functions
