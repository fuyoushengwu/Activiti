...
/**
 * Simple JSR-236 job executor to allocate threads through {@link ManagedThreadFactory}. Falls back
 * to {@link DefaultJobExecutor} when a thread factory was not referenced in configuration.
 *
