...
public class DefaultActivityBehaviorFactory extends AbstractBehaviorFactory
  ...
  public ServiceTaskExpressionActivityBehavior createServiceTaskExpressionActivityBehavior(
    ...
    return new ServiceTaskExpressionActivityBehavior(
        serviceTask.getId(), expression, skipExpression, serviceTask.getResultVariableName());
  }
  ...
  protected ActivityBehavior createMuleActivityBehavior(
      TaskWithFieldExtensions task, List<FieldExtension> fieldExtensions, BpmnModel bpmnModel) {
    try {
  ...
  private void addExceptionMapAsFieldDeclaraion(
  ...
  public ActivityBehavior createBusinessRuleTaskActivityBehavior(
    ...
    if (businessRuleTask.getResultVariableName() != null
        && !businessRuleTask.getResultVariableName().isEmpty()) {
