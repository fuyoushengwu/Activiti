...
public class ParallelMultiInstanceBehavior extends MultiInstanceActivityBehavior {
  ...
  public ParallelMultiInstanceBehavior(
      ActivityImpl activity, AbstractBpmnActivityBehavior originalActivityBehavior) {
  ...
  protected void createInstances(ActivityExecution execution) throws Exception {
    ...
    // See ACT-1586: ExecutionQuery returns wrong results when using multi instance on a receive
    // task
