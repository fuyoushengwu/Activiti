...
public class IdentityInfoEntityManager extends AbstractManager {
  ...
  public void setUserInfo(
    ...
    if (identityInfoEntity != null) {
      ...
      List<IdentityInfoEntity> identityInfoDetails =
          findIdentityInfoDetails(identityInfoEntity.getId());
  ...
  private void insertAccountDetails(
      IdentityInfoEntity identityInfoEntity, Map<String, String> accountDetails, Set<String> keys) {
  ...
  public IdentityInfoEntity findUserInfoByUserIdAndKey(String userId, String key) {
    ...
    return (IdentityInfoEntity)
        getDbSqlSession().selectOne("selectIdentityInfoByUserIdAndKey", parameters);
  }
