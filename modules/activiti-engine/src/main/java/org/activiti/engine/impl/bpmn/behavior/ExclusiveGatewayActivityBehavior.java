...
public class ExclusiveGatewayActivityBehavior extends GatewayActivityBehavior {
   ...
   *
   * <p>Hence, this behaviour is overriden and replaced by the correct behavior: selecting the first
  ...
  protected void leave(ActivityExecution execution) {
    ...
    Iterator<PvmTransition> transitionIterator =
        execution.getActivity().getOutgoingTransitions().iterator();
