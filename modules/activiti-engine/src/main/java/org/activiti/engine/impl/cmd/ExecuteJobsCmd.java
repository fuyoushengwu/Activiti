    ...
    try {
      ...
      failedJobListener =
          new FailedJobListener(
              commandContext.getProcessEngineConfiguration().getCommandExecutor(), jobId);
      commandContext
          .getTransactionContext()
          .addTransactionListener(TransactionState.ROLLED_BACK, failedJobListener);
      ...
      // Dispatch an event, indicating job execution failed in a try-catch block, to prevent the
      // original
