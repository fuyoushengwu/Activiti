...
public abstract class AbstractSetProcessInstanceStateCmd implements Command<Void> {
  ...
  public Void execute(CommandContext commandContext) {
    ...
    ExecutionEntity executionEntity =
        commandContext.getExecutionEntityManager().findExecutionById(executionId);

    if (executionEntity == null) {
      throw new ActivitiObjectNotFoundException(
          "Cannot find processInstance for id '" + executionId + "'.", Execution.class);
    }
    ...
    List<ExecutionEntity> childExecutions =
        commandContext
            ...
            .findChildExecutionsByProcessInstanceId(executionId);
    ...
    List<TaskEntity> tasks =
        commandContext.getTaskEntityManager().findTasksByProcessInstanceId(executionId);
