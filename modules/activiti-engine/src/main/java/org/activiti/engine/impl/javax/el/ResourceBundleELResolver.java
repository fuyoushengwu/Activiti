...
public class ResourceBundleELResolver extends ELResolver {
   ...
   * @param base The bundle to analyze. Only bases of type ResourceBundle are handled by this
   *     resolver.
   ...
   *
   * <ul>
   *   <li>displayName - The String key name
   *   <li>name - Same as displayName property
   *   <li>shortDescription - Empty string
   *   <li>expert - false
   *   <li>hidden - false
   *   <li>preferred - true
   * </ul>
   ...
   *
   * <ul>
   *   <li>{@link ELResolver#TYPE} - String.class.
   ...
   * only. If the base is ResourceBundle, the propertyResolved property of the ELContext object must
   * be set to true by this resolver, before returning. If this property is not true after this
   ...
   * returned. If the base is ResourceBundle, the propertyResolved property of the ELContext object
   * must be set to true by this resolver, before returning. If this property is not true after this
   * method is called, the caller should ignore the return value.
   *
   * @param context The context of this evaluation.
   * @param base The bundle to analyze. Only bases of type ResourceBundle are handled by this
   ...
   * @return If the propertyResolved property of ELContext was set to true, then null if property is
   *     null; otherwise the Object for the given key (property coerced to String) from the
   *     ResourceBundle. If no object for the given key can be found, then the String "???" + key +
   *     "???".
   * @throws NullPointerException if context is null.
