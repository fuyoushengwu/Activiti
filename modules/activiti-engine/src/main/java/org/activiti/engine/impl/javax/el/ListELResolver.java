...
public class ListELResolver extends ELResolver {
   ...
   *
   * @param readOnly true if this resolver cannot modify lists; false otherwise.
   */
   ...
   * property argument. Otherwise, returns null. Assuming the base is a List, this method will
   * always return Integer.class. This is because Lists accept integers as their index.
   *
   * @param context The context of this evaluation.
   * @param base The list to analyze. Only bases of type List are handled by this resolver.
   ...
   * list. If the base is a List, the propertyResolved property of the ELContext object must be set
   * to true by this resolver, before returning. If this property is not true after this method is
   * called, the caller should ignore the return value. Assuming the base is a List, this method
   * will always return Object.class. This is because Lists accept any object as an element.
   *
   * @param context The context of this evaluation.
   * @param base The list to analyze. Only bases of type List are handled by this resolver.
   * @param property The index of the element in the list to return the acceptable type for. Will be
   ...
   * the property argument, and coerced into an integer. If the coercion could not be performed, an
   * IllegalArgumentException is thrown. If the index is out of bounds, null is returned. If the
   * base is a List, the propertyResolved property of the ELContext object must be set to true by
   * this resolver, before returning. If this property is not true after this method is called, the
  ...
  /**
   * If the base object is a list, returns whether a call to {@link #setValue(ELContext, Object,
   * Object, Object)} will always fail. If the base is a List, the propertyResolved property of the
   ...
   * resolver was constructed in read-only mode, this method will always return true. If a List was
   * created using java.util.Collections.unmodifiableList(List), this method must return true.
   * Unfortunately, there is no Collections API method to detect this. However, an implementation
   * can create a prototype unmodifiable List and query its runtime type to see if it matches the
   ...
   * coercion could not be performed, an IllegalArgumentException is thrown. If the index is out of
   * bounds, a PropertyNotFoundException is thrown. If the base is a List, the propertyResolved
   ...
   * However, an implementation can create a prototype unmodifiable List and query its runtime type
   ...
   *     the set operation is not supported by the underlying list.
   * @throws IllegalArgumentException if the property could not be coerced into an integer.
   * @throws NullPointerException if context is null
   * @throws ELException if an exception was thrown while performing the property or variable
   *     resolution. The thrown exception must be included as the cause property of this exception,
   ...
   * @throws IllegalArgumentException if base property cannot be coerced to an integer.
   * @throws PropertyNotFoundException if base is not null and the computed index is out of bounds
   *     for base.
   */
