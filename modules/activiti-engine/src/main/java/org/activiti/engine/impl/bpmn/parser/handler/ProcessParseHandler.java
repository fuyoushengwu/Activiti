...
public class ProcessParseHandler extends AbstractBpmnParseHandler<Process> {
  ...
  protected ProcessDefinitionEntity transformProcess(BpmnParse bpmnParse, Process process) {
    ...
    currentProcessDefinition.setProperty(
        PROPERTYNAME_DOCUMENTATION,
        process.getDocumentation()); // Kept for backwards compatibility. See ACT-1020
    ...
    createExecutionListenersOnScope(
        bpmnParse, process.getExecutionListeners(), currentProcessDefinition);
    ...
    for (String candidateUser : process.getCandidateStarterUsers()) {
      currentProcessDefinition.addCandidateStarterUserIdExpression(
    ...
    Map<String, Object> variables =
        processDataObjects(bpmnParse, process.getDataObjects(), currentProcessDefinition);
    ...
    if (process.getIoSpecification() != null) {
      IOSpecification ioSpecification =
          createIOSpecification(bpmnParse, process.getIoSpecification());
