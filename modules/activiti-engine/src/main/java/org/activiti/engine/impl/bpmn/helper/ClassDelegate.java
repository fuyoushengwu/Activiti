...
public class ClassDelegate extends AbstractBpmnActivityBehavior
    implements TaskListener, ExecutionListener, SubProcessActivityBehavior {
  ...
  public void execute(ActivityExecution execution) throws Exception {
    ...
    if (!isSkipExpressionEnabled || !SkipExpressionUtil.shouldSkipFlowElement(execution, skipExpression)) {
  ...
  public void signal(ActivityExecution execution, String signalName, Object signalData)
    ...
    if (activityBehaviorInstance instanceof SignallableActivityBehavior) {
      ((SignallableActivityBehavior) activityBehaviorInstance)
          .signal(execution, signalName, signalData);
    } else {
      throw new ActivitiException(
          "signal() can only be called on a "
              + SignallableActivityBehavior.class.getName()
              + " instance");
    }
  }
  ...
  protected ActivityBehavior getActivityBehaviorInstance(ActivityExecution execution) {
    ...
    if (delegateInstance instanceof ActivityBehavior) {
      ...
      return determineBehaviour(
          new ServiceTaskJavaDelegateActivityBehavior((JavaDelegate) delegateInstance), execution);
    } else {
      throw new ActivitiIllegalArgumentException(
          delegateInstance.getClass().getName()
              + " doesn't implement "
  ...
  protected ActivityBehavior determineBehaviour(
      ActivityBehavior delegateInstance, ActivityExecution execution) {
