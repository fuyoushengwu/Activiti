  ...
  public Object invoke(
    ...
    if (base == null) {
      throw new PropertyNotFoundException(
          LocalMessages.get("error.property.base.null", property.getPrefix()));
    }
    ...
    //		if (returnType != null && !returnType.isInstance(result)) { // should we check returnType
    // for method invocations?
    //			throw new MethodNotFoundException(LocalMessages.get("error.property.method.notfound", name,
    // base.getClass()));
    //		}
    return result;
  }
