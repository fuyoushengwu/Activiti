...
public class TableDataManager extends AbstractManager {
    ...
    private static final Logger log = LoggerFactory.getLogger(TableDataManager.class);
    ...
    public List<String> getTablesPresentInDatabase() {
        ...
        try {
            ...
            try {
                ...
                String catalog = null;
                if (getProcessEngineConfiguration().getDatabaseCatalog() != null && !getProcessEngineConfiguration().getDatabaseCatalog().isEmpty()) {
                    catalog = getProcessEngineConfiguration().getDatabaseCatalog();
                }

                String schema = null;
                if (getProcessEngineConfiguration().getDatabaseSchema() != null && !getProcessEngineConfiguration().getDatabaseSchema().isEmpty()) {
                    if ("oracle".equals(getDbSqlSession().getDbSqlSessionFactory().getDatabaseType())) {
    ...
    protected long getTableCount(String tableName) {
        ...
        return (Long) getDbSqlSession().selectOne("selectTableCount",
