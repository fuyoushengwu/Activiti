...
public class ProcessDefinitionBuilder {
  ...
  public ProcessDefinitionBuilder startTransition(
      String destinationActivityId, String transitionId) {
      ...
      if (destination == null) {
        throw new ActivitiException(
            "destination '"
                ...
                + "' not found.  (referenced from transition in '"
  ...
  public ProcessDefinitionBuilder executionListener(
      String eventName, ExecutionListener executionListener) {
    if (transition == null) {
