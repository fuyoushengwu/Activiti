...
public class ErrorEventDefinitionParseHandler
    ...
    if (bpmnParse.getCurrentFlowElement() instanceof StartEvent) {
      ...
      activity.setActivityBehavior(
          bpmnParse
              ...
              .createBoundaryEventActivityBehavior(boundaryEvent, interrupting, activity));
      ActivityImpl parentActivity = scope.findActivity(boundaryEvent.getAttachedToRefId());
      createBoundaryErrorEventDefinition(eventDefinition, interrupting, parentActivity, activity);
    }
  }

  protected void createErrorStartEventDefinition(
      ErrorEventDefinition errorEventDefinition, ActivityImpl startEventActivity, ScopeImpl scope) {
    org.activiti.engine.impl.bpmn.parser.ErrorEventDefinition definition =
        new org.activiti.engine.impl.bpmn.parser.ErrorEventDefinition(startEventActivity.getId());
  ...
  public void createBoundaryErrorEventDefinition(
    ...
    org.activiti.engine.impl.bpmn.parser.ErrorEventDefinition definition =
        new org.activiti.engine.impl.bpmn.parser.ErrorEventDefinition(
  ...
  protected void addErrorEventDefinition(
      org.activiti.engine.impl.bpmn.parser.ErrorEventDefinition errorEventDefinition,
      ScopeImpl catchingScope) {
    List<org.activiti.engine.impl.bpmn.parser.ErrorEventDefinition> errorEventDefinitions =
        (List<org.activiti.engine.impl.bpmn.parser.ErrorEventDefinition>)
            catchingScope.getProperty(PROPERTYNAME_ERROR_EVENT_DEFINITIONS);
    if (errorEventDefinitions == null) {
      errorEventDefinitions =
          new ArrayList<org.activiti.engine.impl.bpmn.parser.ErrorEventDefinition>();
